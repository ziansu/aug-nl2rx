...
def read_examples(filename):
    ...
    for line1, line2, line3, line4 in zip(df['description'], df['regex'], df['pos_examples'], df['neg_examples']):
        ...
        examples.append(
            Example(
                idx=idx,
                source=line2.strip(),   # regex is source
                target=line1.strip(),   # nl is target
                positive=line3,
...
def main():
    ...
    parser.add_argument("--do_test", action='store_true',
                        help="Whether to run eval on the dev set.")
    parser.add_argument("--do_diverse", action='store_true',
                        help="Whether to generate diverse outputs.")
